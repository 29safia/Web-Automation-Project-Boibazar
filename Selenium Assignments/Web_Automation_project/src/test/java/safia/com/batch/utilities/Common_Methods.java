package safia.com.batch.utilities;
...
//wait
    ...
    private WebDriverWait wait = new WebDriverWait(PageDriver.getCurrentDriver(), Duration.ofSeconds(60));
    ...
    public void waitForElementToBeVisible(WebElement element, int timeoutInSeconds) {
        WebDriverWait wait = new WebDriverWait(PageDriver.getCurrentDriver(), timeoutInSeconds(90));
        wait.until(ExpectedConditions.visibilityOf(element));
    }

    private Duration timeoutInSeconds(int i) {
